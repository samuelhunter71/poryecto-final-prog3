...
class XPathTest(unittest.TestCase):
    ...
    def test_login_and_logout(self):
        ...
        calificaciones = driver.find_element(By.XPATH, "/html/body/div[2]/nav/ul[2]/li[2]/div/div/div/div/div/div/a[3]/span")
        ...
        materia = driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div/div/div/section/div/div/table/tbody/tr[3]/td[1]/a")
        time.sleep(2)
        materia.click()
        
        body= driver.find_element(By.XPATH, "/html/body")
        body.screenshot('capturas_de_pantalla/calificaciones4.png')
        time.sleep(2) 
